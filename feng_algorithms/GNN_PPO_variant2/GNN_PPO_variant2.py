...
class GNN_PPO_variant2(OnPolicyAlgorithm):
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                policy_loss = -th.min(policy_loss_1, policy_loss_2).mean() # this one is small
                ...
                value_loss = F.mse_loss(rollout_data.returns, values_pred) # this one is large
    ...
    def learn(
        ...
        tb_log_name: str = "GNN_PPO_variant2",
